...
contract SupplyChain {
  ...
  modifier forSale(Item storage _item) {
    require(_item.price > 0 && _item.state == State.ForSale);
    _;
  }
  ...
  function buyItem(uint sku) public payable forSale(items[sku]) paidEnough(sku) checkValue(sku) {
